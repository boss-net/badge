  ...
  verbose(true) do
    sh <<-RETRY_BUNDLE_AUDIT_SHELL
      ...
      if [ "$apply_bundle_audit" = 't' ] ; then
        ...
        # https://github.com/boss-net/badge/pull/1298
...
task :load_self_json do
  require 'json'
  require 'open-uri'
  url = 'https://master.boss-net.github.io/badge/projects/1.json'
...
namespace :fastly do
  ...
  task :test, [:site_name] do |_t, args|
    args.with_defaults site_name: 'https://master.boss-net.github.io/badge/projects/1/badge'
