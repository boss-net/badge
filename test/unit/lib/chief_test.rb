...
class ChiefTest < ActiveSupport::TestCase
  setup do
    @full_name = 'linuxfoundation/cii-badge'
    @repo_name = 'badge'
  ...
  test 'OpenSSF badge results correct' do
    ...
    assert_equal 'Non-trivial contribution file in repository: <https://github.com/boss-net/badge/blob/main/CONTRIBUTING.md>.',
