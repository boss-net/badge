...
gem 'actionview', '~> 7.1.0' # Rails. View.
gem 'activejob', '~> 7.1.0' # Rails. Async jobs.
gem 'activemodel', '~> 7.1.0' # Rails. Model basics.
gem 'activerecord', '~> 7.1.0' # Rails. ORM and query system.
# gem 'activestorage' # Not used. Attaches cloud files to ActiveRecord.
gem 'activesupport', '~> 7.1.0' # Rails. Underlying library.
