...
[GitHub site as issues or pull requests](https://github.com/boss-net/badge).
There is also a
[mailing list for general discussion](https://lists.boss-net.org/mailman/listinfo/cii-badges).
