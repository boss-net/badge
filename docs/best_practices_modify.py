#!/usr/bin/python3
# Modify boss-net.github.io/badge project entries via API
...
STAGING_BASE_URL = 'https://staging.boss-net.github.io/badge/'
PRODUCTION_BASE_URL = 'https://boss-net.github.io/badge/'
