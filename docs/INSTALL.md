...
<https://github.com/boss-net/badge>,
...
~~~~sh
git remote add upstream https://github.com/boss-net/badge.git
~~~~

<!-- If you have edit rights, do this instead:
git clone <https://github.com/boss-net/badge.git>
cd cii-badge
-->
...
2.  Remove the cii-badge directory. (WARNING: This will remove
...
~~~~sh
    ...
    export GITHUB_TOKEN='...'
    scorecard --repo=github.com/boss-net/badge \
