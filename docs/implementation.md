...
(at the top of the tree, typically in "~/cii-badge").
...
The detective classes are located in the directory often located in the directory ./workspace/cii-badge/app/lib.  This directory contains all of the detectives and has a very specific naming convention.  All new detectives must be named name1_detective.rb.  This name is important as it will be called by the primary code chief.rb which calls and collects the results of all of the detective classes.
...
checklink-norobots -b -e \
  https://github.com/boss-net/badge | tee results
~~~~
...
p[:repo_url] = 'https://github.com/boss-net/badge'
p[:homepage_url] = 'https://github.com/boss-net/badge'
...
select the badge application, Project Settings,
...
https://app.circleci.com/settings/project/github/boss-net/badge/ssh
...
[display the statistics graphically](https://boss-net.github.io/badge/project_stats), but it is
