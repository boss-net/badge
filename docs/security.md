...
https://app.circleci.com/pipelines/github/boss-net/badge?branch=master
...
The "boss-net.org" domain is included in
[Chrome's HTTP Strict Transport Security (HSTS) preload list](https://hstspreload.org/?domain=boss-net.org).
...
[analysis by Snyk](https://snyk.io/test/github/boss-net/badge?severity=high&severity=medium&severity=low).
...
* The software has a strong test suite; our policy requires
  ...
  [BadgeApp repository](https://github.com/boss-net/badge).
...
For the main boss-net.github.io/badge site we have:

* An "A+" rating from the
  <a href="https://www.ssllabs.com/ssltest/analyze.html?d=boss-net.github.io/badge">Qualys SSL labs check of our TLS configuration</a>
  on 2017-01-14.
* An "A+" rating from the
  <a href="https://securityheaders.io/?q=https%3A%2F%2Fboss-net.github.io/badge">securityheaders.io check of our HTTP security headers</a>
  on 2018-01-25.
...
* An all-pass report from the
  <a href="https://www.sslshopper.com/ssl-checker.html#hostname=boss-net.github.io/badge">SSLShopper SSL checker</a>
  on 2017-01-14.
* An "A+" rating from the [Mozilla Observatory](https://observatory.mozilla.org/analyze.html?host=boss-net.github.io/badge) scan summary
  on 2017-01-14.
* A 96% result from <a href="https://www.wormly.com/test_ssl/h/boss-net.github.io/badge/i/157.52.75.7/p/443">Wormly</a>.
...
You can see the
[CII Best Practices Badge entry for the BadgeApp](https://boss-net.github.io/badge/en/projects/1/0).
