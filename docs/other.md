...
<a href="https://boss-net.github.io/badge/criteria/0">passing
criteria</a>,
<a href="https://boss-net.github.io/badge/criteria">all
criteria</a>, and the
<a href="https://boss-net.github.io/badge/criteria_discussion">criteria discussion</a>.
...
Please
[post an issue](https://github.com/boss-net/badge/issues)
...
*   Upgrade dynamic_analysis_unsafe from SUGGESTED to MUST.
    ...
    *NOTE*:
    ...
    <a href="https://github.com/boss-net/badge/issues/256">consider giving links to asan/msan/tsan/ubsan and libFuzzer</a>
...
*   <a name="code_of_conduct"></a>The project MUST adopt a code of conduct and
    ...
    *Rationale* Suggested in
    <a href="https://github.com/boss-net/badge/issues/608">issue#608</a>
...
*   <a name="documentation_security"></a>
    ...
    *Rationale*: Writing the specification helps the developers think about the
    ...
    <a href="https://github.com/boss-net/badge/issues/502">Security specification and facilitation of bug bounties</a>
    and by the
    <a href="https://github.com/boss-net/badge/issues/473">NYC 2016 brainstorming session</a>.
...
*   <a name="documentation_quick_start"></a>
    ...
    *Rationale*:
    ...
    https://github.com/boss-net/badge/issues/645
...
*   <a name="build_standard_variables"></a>
    ...
    *Rationale*: See
    <a href="https://github.com/boss-net/badge/issues/453">Build system should honor CC, CFLAGS, CXX, CXXFLAGS</a>
...
*   <a name="installation_standard_variables"></a>
    ...
    *Rationale*   : This supports capturing the artifacts (e.g., for analysis)
    ...
    <a href="https://github.com/boss-net/badge/issues/455">DESTDIR honored at install time</a>
...
*   <a name="crypto_algorithm_agility"></a>
    ...
    *Rationale*:
    ...
    <a href="https://github.com/boss-net/badge/issues/215">Remove requirement for supporting alternative crypto algorithms (crypto_alternatives)?</a>
...
*   <a name="#code_review_standards"></a>
    ...
    *Rationale*: Code review is a cornerstone of quality and
    ...
    See
    https://github.com/boss-net/badge/issues/699
    from GeorgLink.
